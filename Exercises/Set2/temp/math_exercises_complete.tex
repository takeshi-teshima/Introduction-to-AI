...
\begin{questionbox}[label=q:1-indicator-function]{指示関数（Indicator function）の理解 \hfill \tikz[baseline=-0.8ex] \node[draw=white, rounded corners=2pt, inner sep=2.5pt, text=white, font=\small\bfseries, line width=0.5pt] {確認};\hspace{2pt}}
...
\begin{questionbox}[label=q:1-variance-formula-proof]{共分散（Covariance）の2次形式的振る舞い \hfill \tikz[baseline=-0.8ex] \node[draw=white, rounded corners=2pt, inner sep=2.5pt, text=white, font=\small\bfseries, line width=0.5pt] {発展};\hspace{2pt}}
...
\begin{questionbox}[label=q:2-empirical-risk-formulation]{経験リスクの立式 \hfill \tikz[baseline=-0.8ex] \node[draw=white, rounded corners=2pt, inner sep=2.5pt, text=white, font=\small\bfseries, line width=0.5pt] {必須};\hspace{2pt}}
