...
\begin{questionbox}[label=q:3-inner-product-roles]{内積の役割と計算 \hfill \normalfont \small 難易度：★0}
...
\begin{questionbox}[label=q:3-quadratic-form-completing-square]{行列・ベクトルでの二次形式の展開と平方完成 \hfill \normalfont \small 難易度：★2}
